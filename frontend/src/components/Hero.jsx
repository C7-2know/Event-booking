import { Search, ArrowRight, Calendar, Award } from "lucide-react";
    ...
    <div className="relative h-[400px] w-full flex gap-40">
      <div className="flex flex-col justify-center">
        <h1 className="text-6xl font-bold">
          Discover <span className="text-green-700">events</span> worth being
          part of.
        </h1>
        <p className="mt-3 text-gray-900">
          Find local events, connect with people and create memorable
          experiences.
        </p>
        <div className="mt-10 flex max-w-xl items-center border border-gray-200 bg-white p-1 rounded-full">
          <Search className="ml-3 text-green-700" size={19} />
          <input
            value={query}
          ...
          />
          <button className="flex items-center gap-1 bg-green-800 text-white text-sm px-5 py-2 rounded">
            <Award size={17} className="mr-4" /> Search
          </button>
        </div>
      </div>
