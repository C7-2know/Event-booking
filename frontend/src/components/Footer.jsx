        ...
        <div className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <p className="mt-3 text-sm text-gray-500 max-w-xs">
                    Discover events worth being part of. Find local events, connect with people, and create memorable experiences.
                </p>
                <div className="flex gap-3 mt-5">
                    <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-emerald-700">
                    <Facebook size={18} />
                    </a>
                    <a href="#" aria-label="Instagram" className="text-gray-400 hover:text-emerald-700">
                    <Instagram size={18} />
                    </a>
                    <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-emerald-700">
                    <Twitter size={18} />
                    </a>
                </div>
            </div>
        ...
        <div className="border-t border-gray-100">
            <div className="max-w-7xl mx-auto px-8 py flex flex-col sm:flex-row justify-between items-center gap-2">
                ...
                <div className="flex gap-4 text-xs text-gray-400">
                    ...
                    <Link to="/terms" className="hover:text-emerald-700">Terms of Service</Link>
                </div>
            </div>
        </div>
    </footer>
